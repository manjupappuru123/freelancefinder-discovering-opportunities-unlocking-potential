...
const ProjectData = () => {
  ...
  const joinSocketRoom = useCallback(async () => {
    await socket.emit("join-chat-room", {
      projectId: params.id,
              ...
              <div className="project-form-body">
                ...
                <span>
                  <div className="form-floating">
                    ...
                    />
                    <label htmlFor="bidAmount">Budget</label>
                  </div>
                  <div className="form-floating">
                    <input
                      type="number"
                ...
                <div className="form-floating">
                  ...
                  />
                  <label htmlFor="proposal">Describe your proposal</label>
                </div>
                ...
                {project.submissionAccepted ? (
                  ...
                  <>
                    ...
                    <div className="form-floating">
                      ...
                      />
                      <label htmlFor="submissionDescription">Describe your work</label>
                    </div>
                    {project.submission ? (
